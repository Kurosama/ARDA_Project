   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%%%%   Ultima modifica:  27 novembre 2009      %%%%%
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hypersetup{
  ...
  pdftitle={Tesi di laurea triennale},
  pdfauthor={Alessio Pellin},
  pdfsubject={pre-destinazione:\\ MODELLI ED ESPERIMENTI PER LA PREVISIONE DI TRAIETTORIE},
  pdfkeywords={tesi LaTex previsioni di traiettorie}} % Queste informazioni non vengono stampate, ma sono conservate nel documento pdf. Sono consultabili col menu "File>Document Properites>Description". Vengono buone a scopi archivistici.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\setlength{\headheight}{14.5pt}
 ...
 \titolo{Pre-destinazione:\\ MODELLI ED ESPERIMENTI PER \\ LA PREVISIONE DI TRAIETTORIE}
 \laureando{Alessio Pellin}
 \annoaccademico{2014-2015}
 \corsodilaureatriennale{Informatica}
 \relatore{Ivan Scagnetto}
% \dedica{A mia moglie Fatima} % (facoltativo)
...
\input{./extra/appendice}

\backmatter

\input{./extra/bibliografia}
